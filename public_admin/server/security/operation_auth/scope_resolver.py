...
class OperationScopeResolver:
    def __init__(self):
        self.exact = {
            ...
            ('GET', '/admin/api/license/list'): 'account_ops',
            ('GET', '/admin/api/license/clients'): 'account_ops',
            ('GET', '/admin/api/license/blacklist'): 'account_ops',
            ('GET', '/admin/api/license/online-clients'): 'account_ops',
            ('GET', '/admin/api/license/logs'): 'account_ops',
            ('GET', '/admin/api/license/local-logs'): 'account_ops',
            ('GET', '/admin/api/license/products'): 'account_ops',
            ('GET', '/admin/api/credits/overview'): 'account_ops',
            ('GET', '/admin/api/credits/transactions'): 'account_ops',
            ('POST', '/admin/api/credits/config'): 'account_ops',
            ('POST', '/admin/api/credits/topup'): 'account_ops',
            ('GET', '/admin/api/meeting/candidates'): 'account_ops',
            ('GET', '/admin/api/meeting/permissions'): 'account_ops',
        ...
        self.prefixes = [
            ...
            ('GET', '/admin/api/license/info/', 'account_ops'),
            ('GET', '/admin/api/license/clients/', 'account_ops'),
