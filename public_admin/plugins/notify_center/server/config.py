...
class NotifyCenterConfig:
    ...
    def from_env(cls) -> 'NotifyCenterConfig':
        return cls(
            ...
            ntfy_default_server_url=str(os.environ.get('NOTIFY_CENTER_NTFY_DEFAULT_SERVER_URL') or 'https://ak2025.vip').strip().rstrip('/') or 'https://ak2025.vip',
        )
