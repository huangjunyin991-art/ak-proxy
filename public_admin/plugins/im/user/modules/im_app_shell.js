    ...
    const appShellModule = {
        ...
        buildStyleText() {
            return `
                ...
                #ak-im-root .ak-im-composer-btn{width:38px;height:38px;border:1px solid rgba(15,23,42,.14);border-radius:999px;background:#ffffff;color:#111827;display:inline-flex;align-items:center;justify-content:center;cursor:pointer;padding:0;box-shadow:none;flex:0 0 auto;transition:border-color .18s ease,background .18s ease,opacity .18s ease,transform .18s ease,color .18s ease}
                #ak-im-root .ak-im-composer-btn svg{width:22px;height:22px;stroke:currentColor;fill:none;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}
                ...
                #ak-im-root .ak-im-composer-btn.is-active{color:#111827;border-color:rgba(15,23,42,.2);background:#ffffff}
                #ak-im-root .ak-im-composer-voice .ak-im-icon-default,#ak-im-root .ak-im-emoji-toggle .ak-im-icon-default{width:24px;height:24px}
        ...
        buildMarkupText() {
            ...
            <div class="ak-im-shell">
                ...
                <div class="ak-im-screen ak-im-chat-screen">
                    ...
                    <div class="ak-im-composer"><div class="ak-im-composer-side"><button class="ak-im-composer-btn ak-im-composer-voice" type="button" aria-label="切换到按住说话"><svg class="ak-im-icon-default" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 6.5v11"></path><path d="M9.25 8.25c-.95 1.15-1.35 2.4-1.35 3.75s.4 2.6 1.35 3.75"></path><path d="M14.75 8.25c.95 1.15 1.35 2.4 1.35 3.75s-.4 2.6-1.35 3.75"></path><path d="M6.75 10.15c-.5.58-.75 1.2-.75 1.85s.25 1.27.75 1.85"></path><path d="M17.25 10.15c.5.58.75 1.2.75 1.85s-.25 1.27-.75 1.85"></path></svg><svg class="ak-im-icon-alt" viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5.5" width="16" height="11" rx="2"></rect><path d="M8 19h8"></path><path d="M7.5 9.5h.01"></path><path d="M10.5 9.5h.01"></path><path d="M13.5 9.5h.01"></path><path d="M16.5 9.5h.01"></path><path d="M7.5 12.5h9"></path></svg></button></div><div class="ak-im-composer-main"><div class="ak-im-input-wrap"><textarea class="ak-im-input" placeholder="输入消息"></textarea></div><button class="ak-im-hold-to-talk" type="button">按住 说话</button></div><div class="ak-im-composer-actions"><button class="ak-im-composer-btn ak-im-emoji-toggle" type="button" aria-label="打开表情面板"><svg class="ak-im-icon-default" viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9.25"></circle><path d="M8.35 14.25c.95 1.15 2.17 1.72 3.65 1.72s2.7-.57 3.65-1.72"></path><path d="M9.2 10.15h.01"></path><path d="M14.8 10.15h.01"></path></svg><svg class="ak-im-icon-alt" viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5.5" width="16" height="11" rx="2"></rect><path d="M8 19h8"></path><path d="M7.5 9.5h.01"></path><path d="M10.5 9.5h.01"></path><path d="M13.5 9.5h.01"></path><path d="M16.5 9.5h.01"></path><path d="M7.5 12.5h9"></path></svg></button><button class="ak-im-composer-btn ak-im-composer-plus is-disabled" type="button" aria-label="更多功能" disabled><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 5v14"></path><path d="M5 12h14"></path></svg></button><button class="ak-im-send" type="button">发送</button></div></div>
