    ...
    const appShellModule = {
        ...
        buildStyleText() {
            return `
                ...
                #ak-im-root .ak-im-voice-record-overlay-inner{position:relative;z-index:1;display:flex;flex-direction:column;align-items:center;justify-content:flex-end;gap:28px;min-height:100%;padding:96px 18px calc(120px + env(safe-area-inset-bottom, 0px));box-sizing:border-box}
                ...
                #ak-im-root .ak-im-voice-cancel-zone{position:relative;width:min(62vw,248px);max-width:100%;aspect-ratio:2 / 1;box-sizing:border-box;background:linear-gradient(180deg,rgba(243,244,246,.98) 0%,rgba(209,213,219,.92) 100%);display:flex;align-items:center;justify-content:center;padding:18px 18px 10px;color:#475569;font-size:15px;font-weight:700;line-height:1.35;overflow:hidden;clip-path:ellipse(50% 100% at 50% 100%);box-shadow:0 16px 30px rgba(0,0,0,.12),inset 0 1px 0 rgba(255,255,255,.48);transition:background .18s ease,color .18s ease,box-shadow .18s ease}
                #ak-im-root .ak-im-voice-cancel-zone.is-active{background:linear-gradient(180deg,rgba(248,113,113,.98) 0%,rgba(239,68,68,.94) 100%);color:#ffffff;box-shadow:0 18px 32px rgba(239,68,68,.24),inset 0 1px 0 rgba(255,255,255,.18)}
                #ak-im-root .ak-im-voice-cancel-label{position:relative;z-index:1;white-space:nowrap;transform:translateY(8px)}
