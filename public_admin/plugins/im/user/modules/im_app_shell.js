    ...
    const appShellModule = {
        ...
        buildStyleText() {
            return `
                ...
                #ak-im-root .ak-im-voice-record-card{position:relative;width:min(84vw,336px);max-width:100%;aspect-ratio:2 / 1;box-sizing:border-box;padding:24px 24px 0;border-radius:999px 999px 0 0 / 100% 100% 0 0;background:linear-gradient(180deg,#9bf46d 0%,#83eb57 100%);box-shadow:0 18px 42px rgba(0,0,0,.18);display:flex;flex-direction:column;align-items:center;justify-content:flex-start;gap:10px;color:#1f2937;overflow:hidden;transform:translateY(10px) scale(.96);transition:transform .18s ease,background .18s ease,color .18s ease}
                ...
                #ak-im-root .ak-im-voice-record-meter{position:relative;z-index:1;display:flex;align-items:flex-end;justify-content:center;gap:4px;height:34px;margin-top:10px}
