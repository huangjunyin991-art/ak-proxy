    ...
    const appShellModule = {
        ...
        buildStyleText() {
            return `
                ...
                #ak-im-root .ak-im-voice-record-overlay-inner{position:relative;z-index:1;display:flex;flex-direction:column;align-items:center;justify-content:flex-end;gap:0;min-height:100%;padding:96px 18px calc(112px + env(safe-area-inset-bottom, 0px));box-sizing:border-box}
                #ak-im-root .ak-im-voice-record-card{position:relative;width:min(84vw,336px);max-width:100%;aspect-ratio:2 / 1;box-sizing:border-box;padding:24px 24px 0;background:linear-gradient(180deg,#9bf46d 0%,#83eb57 100%);filter:drop-shadow(0 18px 42px rgba(0,0,0,.18));display:flex;flex-direction:column;align-items:center;justify-content:flex-start;gap:10px;color:#1f2937;overflow:hidden;clip-path:ellipse(50% 100% at 50% 100%);transform:translateY(10px) scale(.96);transition:transform .18s ease,background .18s ease,color .18s ease}
                ...
                #ak-im-root .ak-im-voice-record-meter{position:relative;z-index:1;display:flex;align-items:flex-end;justify-content:center;gap:4px;height:34px;margin-top:14px}
                ...
                #ak-im-root .ak-im-voice-record-timer{position:relative;z-index:1;margin-top:2px;font-size:18px;font-weight:800;line-height:1.1;letter-spacing:.04em}
                #ak-im-root .ak-im-voice-cancel-zone{position:absolute;left:50%;bottom:0;width:min(60vw,220px);max-width:64%;aspect-ratio:2 / 1;box-sizing:border-box;transform:translateX(-50%);background:linear-gradient(180deg,rgba(243,244,246,.98) 0%,rgba(209,213,219,.92) 100%);display:flex;align-items:center;justify-content:center;padding:20px 18px 10px;color:#475569;font-size:15px;font-weight:700;line-height:1.35;overflow:hidden;clip-path:ellipse(50% 100% at 50% 100%);box-shadow:inset 0 1px 0 rgba(255,255,255,.48);transition:background .18s ease,color .18s ease,box-shadow .18s ease,filter .18s ease}
                #ak-im-root .ak-im-voice-cancel-zone.is-active{background:linear-gradient(180deg,rgba(248,113,113,.98) 0%,rgba(239,68,68,.94) 100%);color:#ffffff;box-shadow:inset 0 1px 0 rgba(255,255,255,.18);filter:drop-shadow(0 10px 22px rgba(239,68,68,.22))}
