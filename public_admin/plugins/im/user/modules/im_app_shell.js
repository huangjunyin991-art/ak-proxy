    ...
    const appShellModule = {
        ...
        buildStyleText() {
            return `
                ...
                #ak-im-root .ak-im-voice-track-progress{position:absolute;left:0;top:0;bottom:0;width:calc(var(--ak-im-voice-progress,0) * 100%);background:linear-gradient(90deg,rgba(255,255,255,.4) 0%,rgba(255,255,255,.2) 55%,rgba(255,255,255,.04) 100%);opacity:0;filter:blur(10px);transition:width .1s linear,opacity .16s ease}
                #ak-im-root .ak-im-message-row.ak-peer .ak-im-voice-track-progress{background:linear-gradient(90deg,rgba(7,193,96,.18) 0%,rgba(7,193,96,.1) 58%,rgba(7,193,96,0) 100%)}
                #ak-im-root .ak-im-voice-track-scan{position:absolute;top:4px;bottom:4px;left:calc(var(--ak-im-voice-progress,0) * 100%);width:38%;border-radius:999px;transform:translateX(-50%);background:radial-gradient(90% 80% at 50% 50%,rgba(255,255,255,.82) 0%,rgba(255,255,255,.28) 42%,rgba(255,255,255,0) 100%);filter:blur(8px);opacity:0;transition:left .1s linear,opacity .16s ease}
                #ak-im-root .ak-im-message-row.ak-peer .ak-im-voice-track-scan{background:radial-gradient(90% 80% at 50% 50%,rgba(34,197,94,.34) 0%,rgba(34,197,94,.16) 45%,rgba(34,197,94,0) 100%)}
                #ak-im-root .ak-im-voice-bubble-surface.is-active .ak-im-voice-track-progress{opacity:.96}
