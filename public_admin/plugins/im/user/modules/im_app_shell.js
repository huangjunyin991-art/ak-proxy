    ...
    const appShellModule = {
        ...
        buildStyleText() {
            return `
                ...
                #ak-im-root.ak-view-group-admins .ak-im-group-admins-screen{display:flex}
                ...
                #ak-im-root .ak-im-avatar-mosaic.is-duo{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:1px;padding:1px;box-sizing:border-box;background:#ffffff}
                #ak-im-root .ak-im-avatar-mosaic.is-duo .ak-im-avatar-cell{width:100%;height:100%}
                #ak-im-root .ak-im-avatar-mosaic.is-duo .ak-im-avatar-photo{object-fit:contain;background:#ffffff}
                #ak-im-root .ak-im-avatar-mosaic.is-trio{display:flex;flex-direction:column;justify-content:center;gap:1px;padding:1px;box-sizing:border-box;background:#ffffff}
                #ak-im-root .ak-im-avatar-mosaic.is-trio .ak-im-avatar-row{flex:1 1 0;display:flex;align-items:stretch;justify-content:center;gap:1px;min-height:0}
                #ak-im-root .ak-im-avatar-mosaic.is-trio .ak-im-avatar-cell{flex:0 0 calc((100% - 1px)/2);width:calc((100% - 1px)/2)}
                #ak-im-root .ak-im-avatar-mosaic.is-quad{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));grid-template-rows:repeat(2,minmax(0,1fr));gap:1px;padding:1px;box-sizing:border-box;background:#ffffff}
                #ak-im-root .ak-im-avatar-mosaic.is-quad .ak-im-avatar-cell{width:100%;height:100%}
                ...
                #ak-im-root .ak-im-avatar-mosaic.is-stack .ak-im-avatar-cell{flex:0 0 calc((100% - 2px)/3);width:calc((100% - 2px)/3)}
                ...
                #ak-im-root .ak-im-session-body{position:relative;min-width:0;flex:1;display:grid;grid-template-columns:1fr auto;grid-template-areas:'name time' 'preview preview';align-items:center;column-gap:10px;row-gap:4px}
                ...
                #ak-im-root .ak-im-session-preview{grid-area:preview;padding-right:30px;font-size:13px;color:#6b7280;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
                #ak-im-root .ak-im-session-unread{position:absolute;right:0;bottom:0;min-width:18px;height:18px;padding:0 5px;border-radius:999px;background:#ef4444;color:#fff;font-size:11px;font-weight:700;display:none;align-items:center;justify-content:center;box-sizing:border-box;box-shadow:0 0 0 2px #ffffff}
                ...
                #ak-im-root .ak-im-reply-draft{display:none;margin:0;padding:8px 10px 0;background:#f7f7f7}
                #ak-im-root .ak-im-reply-draft.is-open{display:flex}
                #ak-im-root .ak-im-reply-draft-card{flex:1;min-width:0;display:flex;align-items:center;gap:8px;padding:8px 10px;border-radius:12px;background:#fff;box-shadow:0 1px 2px rgba(15,23,42,.06);border-left:3px solid #07c160}
                #ak-im-root .ak-im-reply-draft-text{min-width:0;flex:1;display:flex;flex-direction:column;gap:2px}
                #ak-im-root .ak-im-reply-draft-title{font-size:12px;font-weight:700;line-height:1.25;color:#111827;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
                #ak-im-root .ak-im-reply-draft-preview{font-size:12px;line-height:1.35;color:#64748b;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
                #ak-im-root .ak-im-reply-draft-close{width:26px;height:26px;border:none;border-radius:13px;background:#f1f5f9;color:#475569;display:inline-flex;align-items:center;justify-content:center;cursor:pointer;font-size:18px;line-height:1;flex:0 0 auto}
                #ak-im-root .ak-im-reply-quote{max-width:min(72vw,420px);margin:0 0 4px;padding:6px 8px;border-radius:10px;background:rgba(241,245,249,.86);border-left:3px solid rgba(100,116,139,.38);color:#475569;box-sizing:border-box}
                #ak-im-root .ak-im-message-row.ak-self .ak-im-reply-quote{margin-left:auto;background:rgba(236,253,245,.72);border-left-color:rgba(22,163,74,.38)}
                #ak-im-root .ak-im-reply-quote-title{font-size:11px;font-weight:700;line-height:1.3;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
                #ak-im-root .ak-im-reply-quote-preview{margin-top:2px;font-size:12px;line-height:1.35;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
                ...
                #ak-im-root .ak-im-voice-hint{display:none;flex:1 0 100%;margin-top:4px;padding:0 2px;font-size:12px;line-height:1.4;color:#64748b}
                #ak-im-root.ak-im-composer-voice-mode .ak-im-voice-hint{display:block}
                #ak-im-root .ak-im-composer-voice.is-active{color:#2563eb;background:rgba(37,99,235,.08)}
                ...
                #ak-im-root .ak-im-member-action-count{color:#64748b}
                ...
                #ak-im-root .ak-im-group-admins-screen{background:#ededed}
                #ak-im-root .ak-im-group-admins-page{flex:1;overflow:auto;padding:12px 12px calc(18px + env(safe-area-inset-bottom, 0px));background:#f7f7f7}
                #ak-im-root .ak-im-group-admins-panel{background:#ffffff;border-radius:18px;padding:14px;box-shadow:0 1px 2px rgba(15,23,42,.04)}
                #ak-im-root .ak-im-group-admins-panel + .ak-im-group-admins-panel{margin-top:12px}
                #ak-im-root .ak-im-group-admins-title{font-size:15px;font-weight:700;color:#111827;line-height:1.5}
                #ak-im-root .ak-im-group-admins-desc{margin-top:6px;font-size:12px;color:#6b7280;line-height:1.6}
                #ak-im-root .ak-im-group-admins-list{margin-top:12px;display:flex;flex-direction:column}
                #ak-im-root .ak-im-group-admins-row{width:100%;border:none;background:transparent;padding:12px 0;display:flex;align-items:center;gap:12px;text-align:left}
                #ak-im-root .ak-im-group-admins-row + .ak-im-group-admins-row{border-top:1px solid rgba(15,23,42,.06)}
                #ak-im-root .ak-im-group-admins-avatar{width:44px;height:44px;border-radius:14px;background:linear-gradient(180deg,#8fe3a8 0%,#56c57b 100%);color:#ffffff;display:inline-flex;align-items:center;justify-content:center;font-size:15px;font-weight:700;flex:0 0 auto}
                #ak-im-root .ak-im-group-admins-main{min-width:0;flex:1}
                #ak-im-root .ak-im-group-admins-name{font-size:15px;font-weight:600;color:#111827;line-height:1.4;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;display:flex;align-items:center;min-width:0}
                #ak-im-root .ak-im-group-admins-meta{margin-top:4px;display:flex;align-items:center;gap:6px;flex-wrap:wrap;font-size:12px;color:#6b7280;line-height:1.4}
                #ak-im-root .ak-im-group-admins-role{display:inline-flex;align-items:center;justify-content:center;height:18px;padding:0 6px;border-radius:999px;background:rgba(7,193,96,.12);color:#16a34a;font-size:10px;font-weight:700}
                #ak-im-root .ak-im-group-admins-action{height:32px;border:none;border-radius:999px;padding:0 12px;background:#f3f4f6;color:#374151;font-size:12px;font-weight:700;cursor:pointer;flex:0 0 auto}
                #ak-im-root .ak-im-group-admins-action.is-primary{background:#07c160;color:#ffffff}
                #ak-im-root .ak-im-group-admins-action.is-danger{background:rgba(239,68,68,.1);color:#dc2626}
                #ak-im-root .ak-im-group-admins-action:disabled{opacity:.42;cursor:not-allowed}
                #ak-im-root .ak-im-group-admins-search{margin-top:12px;width:100%;height:38px;border:none;border-radius:12px;background:#f3f4f6;padding:0 14px;font-size:14px;color:#111827;outline:none;box-sizing:border-box}
                #ak-im-root .ak-im-group-admins-error{margin-bottom:12px;padding:11px 12px;border-radius:14px;background:rgba(239,68,68,.08);color:#dc2626;font-size:13px;line-height:1.6}
                #ak-im-root .ak-im-group-admins-empty{padding:24px 14px;color:#9ca3af;font-size:13px;line-height:1.7;text-align:center}
        ...
        buildMarkupText() {
            ...
            <div class="ak-im-shell">
                ...
                <div class="ak-im-screen ak-im-chat-screen">
                    ...
                    <div class="ak-im-plus-sheet" aria-hidden="true" inert><div class="ak-im-plus-sheet-panel"><div class="ak-im-plus-grid"><button class="ak-im-plus-item" type="button" data-im-plus-action="call-audio"><span class="ak-im-plus-item-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6.5 5.5c2.7 0 4.9 2.2 4.9 4.9v1.2c0 .8.6 1.4 1.4 1.4h.8c1.3 0 2.4 1.1 2.4 2.4v1.3c0 1.1-.9 2-2 2h-1.8c-4.8 0-8.7-3.9-8.7-8.7V7.5c0-1.1.9-2 2-2z"></path></svg></span><span class="ak-im-plus-item-label">语音通话</span></button><button class="ak-im-plus-item" type="button" data-im-plus-action="call-video"><span class="ak-im-plus-item-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4.3" y="7.1" width="10.9" height="9.8" rx="2.2"></rect><path d="m15.2 10 4.5-2.5v9l-4.5-2.5z"></path></svg></span><span class="ak-im-plus-item-label">视频通话</span></button><button class="ak-im-plus-item" type="button" data-im-plus-action="camera"><span class="ak-im-plus-item-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8.2 7.4 9.3 5.9h5.4l1.1 1.5"></path><rect x="4.2" y="7.4" width="15.6" height="11.4" rx="2.4"></rect><circle cx="12" cy="13.1" r="3.3"></circle></svg></span><span class="ak-im-plus-item-label">拍照</span></button><button class="ak-im-plus-item" type="button" data-im-plus-action="album"><span class="ak-im-plus-item-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4.3" y="5.2" width="15.4" height="13.6" rx="2.3"></rect><circle cx="9" cy="10" r="1.2"></circle><path d="m7.2 16 3.1-3.1 2.2 2.2 2.6-2.8 1.7 1.8"></path></svg></span><span class="ak-im-plus-item-label">相册</span></button><button class="ak-im-plus-item" type="button" data-im-plus-action="file"><span class="ak-im-plus-item-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4.8 8.4h5l1.3 1.7h8.1v6.9a2 2 0 0 1-2 2H6.8a2 2 0 0 1-2-2Z"></path><path d="M4.8 10.1V7.6a2 2 0 0 1 2-2h3"></path></svg></span><span class="ak-im-plus-item-label">文件</span></button><button class="ak-im-plus-item" type="button" data-im-plus-action="location"><span class="ak-im-plus-item-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 20.1s5.1-5 5.1-9a5.1 5.1 0 1 0-10.2 0c0 4 5.1 9 5.1 9Z"></path><circle cx="12" cy="11.1" r="1.9"></circle></svg></span><span class="ak-im-plus-item-label">位置</span></button></div></div></div>
                ...
                <div class="ak-im-screen ak-im-group-admins-screen">
                    <div class="ak-im-topbar">
                        <button class="ak-im-nav-btn ak-im-group-admins-back" type="button" aria-label="返回群信息页面">
                            <svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M15 18L9 12L15 6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                        </button>
                        <div class="ak-im-topbar-title">群管理员</div>
                        <div class="ak-im-group-info-side" aria-hidden="true"></div>
                    </div>
                    <div class="ak-im-group-admins-page"></div>
                </div>
                ...
                <div class="ak-im-screen ak-im-meeting-publish-screen">
                    <div class="ak-im-topbar">
                        <button class="ak-im-nav-btn ak-im-meeting-publish-back" type="button" aria-label="返回会议列表">
                            <svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M15 18L9 12L15 6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                        </button>
                        <div class="ak-im-topbar-title">发布会议</div>
                        <div class="ak-im-group-info-side" aria-hidden="true"></div>
                    </div>
                    <div class="ak-im-meeting-publish-page">
                        <div class="ak-im-meeting-publish-body"></div>
        ...
        collectElements(root) {
            return {
                ...
                groupAdminsPageEl: root ? root.querySelector('.ak-im-group-admins-screen') : null,
                groupAdminsBodyEl: root ? root.querySelector('.ak-im-group-admins-page') : null,
                groupAdminsBackBtnEl: root ? root.querySelector('.ak-im-group-admins-back') : null,
        ...
        bindEvents() {
            ...
            bindClick(elements.groupAdminsBackBtnEl, function() {
                if (typeof ctx.onGroupAdminsBackClick === 'function') ctx.onGroupAdminsBackClick();
            });
        ...
        renderShell(shellState) {
            ...
            root.classList.toggle('ak-view-group-admins', !!nextShellState.showGroupAdmins);
