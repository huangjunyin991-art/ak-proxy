    ...
    const appShellModule = {
        ...
        buildStyleText() {
            return `
                ...
                #ak-im-root .ak-im-voice-record-overlay-inner{position:relative;z-index:1;display:flex;flex-direction:column;align-items:center;justify-content:flex-end;gap:22px;min-height:100%;padding:96px 18px calc(34px + env(safe-area-inset-bottom, 0px));box-sizing:border-box}
                ...
                #ak-im-root .ak-im-voice-cancel-zone{min-width:min(72vw,280px);min-height:56px;border-radius:999px;background:rgba(255,255,255,.14);backdrop-filter:blur(10px);display:flex;align-items:center;justify-content:center;padding:0 28px;color:#ffffff;font-size:15px;font-weight:600;line-height:1.3;box-shadow:inset 0 1px 0 rgba(255,255,255,.08)}
                #ak-im-root .ak-im-voice-cancel-zone.is-active{background:rgba(239,68,68,.88);color:#ffffff;box-shadow:0 14px 32px rgba(239,68,68,.26)}
                #ak-im-root .ak-im-voice-cancel-label{white-space:nowrap}
