    ...
    const appShellModule = {
        ...
        buildStyleText() {
            return `
                ...
                #ak-im-root .ak-im-composer-btn svg{width:28px;height:28px;stroke:currentColor;fill:none;stroke-width:1.85;stroke-linecap:round;stroke-linejoin:round}
        ...
        buildMarkupText() {
            ...
            <div class="ak-im-shell">
                ...
                <div class="ak-im-screen ak-im-chat-screen">
                    ...
                    <div class="ak-im-composer"><div class="ak-im-composer-side"><button class="ak-im-composer-btn ak-im-composer-voice" type="button" aria-label="切换到按住说话"><svg class="ak-im-icon-default" viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9.6"></circle><path d="M12 9.3v5.4"></path><path d="M9.7 9.05c-.78.82-1.17 1.8-1.17 2.95s.39 2.13 1.17 2.95"></path><path d="M14.3 9.05c.78.82 1.17 1.8 1.17 2.95s-.39 2.13-1.17 2.95"></path><path d="M7.65 10.35c-.42.49-.63 1.04-.63 1.65s.21 1.16.63 1.65"></path><path d="M16.35 10.35c.42.49.63 1.04.63 1.65s-.21 1.16-.63 1.65"></path></svg><svg class="ak-im-icon-alt" viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9.6"></circle><rect x="6.4" y="8.4" width="11.2" height="7.2" rx="1.4"></rect><path d="M9 17.6h6"></path><path d="M8.9 10.8h.01"></path><path d="M11.4 10.8h.01"></path><path d="M13.9 10.8h.01"></path><path d="M16.1 10.8h.01"></path><path d="M8.8 13.2h6.4"></path></svg></button></div><div class="ak-im-composer-main"><div class="ak-im-input-wrap"><textarea class="ak-im-input" placeholder="输入消息"></textarea></div><button class="ak-im-hold-to-talk" type="button">按住 说话</button></div><div class="ak-im-composer-actions"><button class="ak-im-composer-btn ak-im-emoji-toggle" type="button" aria-label="打开表情面板"><svg class="ak-im-icon-default" viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9.85"></circle><path d="M8.25 14.15c.98 1.16 2.23 1.74 3.75 1.74s2.77-.58 3.75-1.74"></path><path d="M9.2 10.15h.01"></path><path d="M14.8 10.15h.01"></path></svg><svg class="ak-im-icon-alt" viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9.6"></circle><rect x="6.4" y="8.4" width="11.2" height="7.2" rx="1.4"></rect><path d="M9 17.6h6"></path><path d="M8.9 10.8h.01"></path><path d="M11.4 10.8h.01"></path><path d="M13.9 10.8h.01"></path><path d="M16.1 10.8h.01"></path><path d="M8.8 13.2h6.4"></path></svg></button><button class="ak-im-composer-btn ak-im-composer-plus is-disabled" type="button" aria-label="更多功能" disabled><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9.6"></circle><path d="M12 7.6v8.8"></path><path d="M7.6 12h8.8"></path></svg></button><button class="ak-im-send" type="button">发送</button></div></div>
