(function(global) {
    ...
    const callModule = {
        ...
        ensureStyle() {
            ...
            styleEl.textContent += [
                '.ak-im-call-overlay[data-kind="video"][data-mode="outgoing"] .ak-im-call-overlay-header,.ak-im-call-overlay[data-kind="video"][data-mode="connecting"] .ak-im-call-overlay-header{background:transparent!important}',
                '.ak-im-call-overlay[data-kind="video"][data-mode="outgoing"] .ak-im-call-overlay-placeholder,.ak-im-call-overlay[data-kind="video"][data-mode="connecting"] .ak-im-call-overlay-placeholder{justify-content:flex-start!important;gap:10px!important;padding:calc(128px + env(safe-area-inset-top,0px)) 28px calc(270px + env(safe-area-inset-bottom,0px))!important;background:transparent!important}',
                '.ak-im-call-overlay[data-kind="video"][data-mode="outgoing"] .ak-im-call-overlay-placeholder-icon,.ak-im-call-overlay[data-kind="video"][data-mode="connecting"] .ak-im-call-overlay-placeholder-icon{width:96px!important;height:96px!important;flex:0 0 96px!important;border-radius:24px!important;background:rgba(255,255,255,.86)!important;color:#0f172a!important;box-shadow:0 16px 42px rgba(2,6,23,.18)!important;overflow:hidden!important}',
                '.ak-im-call-overlay[data-kind="video"][data-mode="outgoing"] .ak-im-call-overlay-placeholder-icon[data-has-avatar="1"],.ak-im-call-overlay[data-kind="video"][data-mode="connecting"] .ak-im-call-overlay-placeholder-icon[data-has-avatar="1"]{background:rgba(255,255,255,.86)!important}',
                '.ak-im-call-overlay[data-kind="video"][data-mode="outgoing"] .ak-im-call-overlay-peer-avatar,.ak-im-call-overlay[data-kind="video"][data-mode="connecting"] .ak-im-call-overlay-peer-avatar{object-fit:contain!important;background:rgba(255,255,255,.86)!important}',
                '.ak-im-call-overlay[data-kind="video"][data-mode="outgoing"] .ak-im-call-overlay-detail,.ak-im-call-overlay[data-kind="video"][data-mode="connecting"] .ak-im-call-overlay-detail{gap:8px!important}',
                '.ak-im-call-overlay[data-kind="video"][data-mode="outgoing"] .ak-im-call-overlay-detail-title,.ak-im-call-overlay[data-kind="video"][data-mode="connecting"] .ak-im-call-overlay-detail-title{font-size:32px!important}',
                '.ak-im-call-overlay[data-kind="video"][data-mode="outgoing"] .ak-im-call-overlay-detail-body,.ak-im-call-overlay[data-kind="video"][data-mode="connecting"] .ak-im-call-overlay-detail-body{margin-top:2px!important;background:rgba(35,35,35,.32)!important}',
                '.ak-im-call-overlay[data-kind="video"][data-mode="outgoing"] .ak-im-call-overlay-placeholder-text,.ak-im-call-overlay[data-kind="video"][data-mode="connecting"] .ak-im-call-overlay-placeholder-text{position:absolute!important;left:18px!important;right:18px!important;bottom:calc(252px + env(safe-area-inset-bottom,0px))!important;margin:0!important;max-width:none!important;font-size:20px!important;line-height:1.25!important;font-weight:400!important;color:rgba(255,255,255,.86)!important;text-shadow:0 2px 10px rgba(0,0,0,.38)!important}',
                '.ak-im-call-overlay[data-kind="video"][data-mode="outgoing"] .ak-im-call-overlay-state,.ak-im-call-overlay[data-kind="video"][data-mode="connecting"] .ak-im-call-overlay-state{bottom:calc(288px + env(safe-area-inset-bottom,0px))!important;font-size:13px!important;color:rgba(255,255,255,.82)!important;text-shadow:0 2px 10px rgba(0,0,0,.38)!important}',
                '.ak-im-call-overlay[data-kind="video"][data-mode="outgoing"][data-video-surface="local"] .ak-im-call-overlay-local,.ak-im-call-overlay[data-kind="video"][data-mode="connecting"][data-video-surface="local"] .ak-im-call-overlay-local{filter:none!important;transform:scaleX(-1)!important}',
