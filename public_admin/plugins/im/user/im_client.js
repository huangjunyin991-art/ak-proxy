(function() {
    ...
    const state = {
        ...
        ntfyDeleting: false,
        ntfyMessage: '',
        ntfyDraftServerUrl: 'https://ak2025.vip/ntfy',
    ...
    function applyNtfyBinding(data) {
        ...
        state.ntfyDraftServerUrl = String(item.server_url || 'https://ak2025.vip/ntfy').trim() || 'https://ak2025.vip/ntfy';
        return item;
    }
    ...
    function saveNtfyBinding(serverUrl) {
        ...
        const normalizedServerUrl = String(serverUrl || state.ntfyDraftServerUrl || 'https://ak2025.vip/ntfy').trim() || 'https://ak2025.vip/ntfy';
    ...
    function deleteNtfyBinding() {
        ...
        return request(`${API_ROOT}/api/notify-center/ntfy/binding`, {
            ...
            state.ntfyBinding = { username: state.username || getCanonicalUsername(), bound: false, enabled: false, server_url: 'https://ak2025.vip/ntfy', topic: '' };
            state.ntfyDraftServerUrl = 'https://ak2025.vip/ntfy';
