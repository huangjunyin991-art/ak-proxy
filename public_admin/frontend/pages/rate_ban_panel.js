(function() {
    ...
    function renderStyles() {
        return [
            ...
            '.rb-hero{position:relative;overflow:hidden;border:1px solid rgba(255,107,122,.22);border-radius:22px;background:radial-gradient(circle at 0 0,rgba(255,107,122,.18),transparent 34%),linear-gradient(135deg,rgba(30,8,12,.96),rgba(45,15,20,.92));padding:20px;box-shadow:0 18px 55px rgba(0,0,0,.22)}',
            '.rb-hero:after{content:"";position:absolute;right:-80px;top:-80px;width:220px;height:220px;border-radius:50%;background:rgba(255,107,122,.12);filter:blur(8px)}',
            ...
            '.rb-eyebrow{color:#ff6b7a;font-size:12px;font-weight:800;letter-spacing:.12em;text-transform:uppercase}',
            ...
            '.rb-status-pill{display:inline-flex;align-items:center;gap:8px;border:1px solid rgba(255,107,122,.28);border-radius:999px;background:rgba(255,107,122,.1);color:#ff8a96;padding:8px 12px;font-size:12px;font-weight:800;white-space:nowrap}',
            ...
            '.rb-btn{min-height:38px;border:0;border-radius:12px;padding:9px 16px;background:linear-gradient(135deg,#ff6b7a,#ff3d5a);color:#fff;font-weight:900;cursor:pointer;box-shadow:0 12px 28px rgba(255,61,90,.22)}',
            '.rb-btn.secondary{background:rgba(255,255,255,.06);color:var(--text-primary);border:1px solid rgba(255,255,255,.12);box-shadow:none}',
            '.rb-btn.danger{background:rgba(255,71,87,.12);color:#ff6b7a;border:1px solid rgba(255,71,87,.25);box-shadow:none}',
            ...
            '.rb-metric strong{display:block;color:#ff8a96;font-size:24px;line-height:1;font-weight:900}',
            ...
            '.rb-ban-dur{color:#ff8a96;font-size:11px}',
            '.rb-section-grid{display:grid;grid-template-columns:repeat(12,minmax(0,1fr));gap:14px}',
            '.rb-section{grid-column:span 6;border:1px solid rgba(255,107,122,.12);border-radius:20px;background:linear-gradient(180deg,rgba(30,10,16,.88),rgba(20,8,12,.94));padding:16px;box-shadow:0 14px 40px rgba(0,0,0,.15)}',
            ...
            '.rb-section-index{display:grid;place-items:center;min-width:34px;height:34px;border-radius:12px;background:rgba(255,107,122,.1);color:#ff8a96;font-weight:900}',
            ...
            '.rb-rule-card{border:1px solid rgba(255,107,122,.16);border-radius:16px;background:rgba(255,107,122,.035);padding:14px}',
            ...
            '.rb-input{width:100%;min-height:36px;border:1px solid rgba(255,255,255,.1);border-radius:11px;padding:8px 10px;color:var(--text-primary);background:rgba(2,10,18,.72);font-size:14px;outline:none}.rb-input:focus{border-color:#ff6b7a;box-shadow:0 0 0 3px rgba(255,107,122,.13)}',
            ...
            '.rb-toggle-card:hover{border-color:rgba(255,107,122,.38);background:rgba(255,107,122,.07);transform:translateY(-1px)}.rb-toggle-card input{position:absolute;opacity:0;pointer-events:none}',
            ...
            '.rb-footer{position:sticky;bottom:0;z-index:3;display:flex;justify-content:space-between;align-items:center;gap:14px;flex-wrap:wrap;border:1px solid rgba(255,255,255,.08);border-radius:18px;background:rgba(20,8,12,.92);backdrop-filter:blur(14px);padding:12px 14px;box-shadow:0 -12px 38px rgba(0,0,0,.18)}',
