(function() {
    ...
    function renderStyles() {
        return [
            ...
            '.rb-btn{min-height:38px;border:0;border-radius:12px;padding:9px 16px;background:linear-gradient(135deg,var(--accent),var(--accent-green));color:#001018;font-weight:900;cursor:pointer;box-shadow:0 12px 28px rgba(0,212,255,.18)}',
