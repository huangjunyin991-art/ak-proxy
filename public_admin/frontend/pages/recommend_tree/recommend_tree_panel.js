(function() {
    ...
    function ensureCss() {
        ...
        if (existing) {
            existing.href = '/admin/api/recommend-tree-panel/recommend_tree_panel.css?v=20260505-17';
            return;
        }
        var link = document.createElement('link');
        link.rel = 'stylesheet';
        link.href = '/admin/api/recommend-tree-panel/recommend_tree_panel.css?v=20260505-17';
