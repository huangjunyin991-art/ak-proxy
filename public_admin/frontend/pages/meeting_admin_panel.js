(function() {
    ...
    function render() {
        ...
        const html = `
            <style>
.meeting-admin-wrap{display:flex;flex-direction:column;gap:16px}.meeting-card{background:linear-gradient(135deg,var(--bg-card),rgba(0,212,255,.04));border:1px solid var(--border);border-radius:16px;padding:16px}.meeting-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;margin-bottom:12px;flex-wrap:wrap}.meeting-head-main{display:flex;flex-direction:column;gap:4px}.meeting-title{font-size:18px;font-weight:800;color:var(--text-primary)}.meeting-subtitle,.meeting-muted,.meeting-empty{color:var(--text-secondary);font-size:12px}.meeting-toolbar{display:flex;align-items:center;gap:10px;flex-wrap:wrap}.meeting-search{height:36px;border-radius:9px;border:1px solid var(--border);background:var(--bg-secondary);color:var(--text-primary);padding:0 10px;min-width:220px;transition:border-color .2s,box-shadow .2s}.meeting-search:focus{outline:none;border-color:var(--accent);box-shadow:0 0 0 3px rgba(0,212,255,.18)}#meetingAdminMount .meeting-small-btn{border:0!important;border-radius:10px;padding:8px 14px;background:linear-gradient(135deg,var(--accent),var(--accent-green))!important;color:#001018!important;font-weight:900;cursor:pointer;font-size:12px;box-shadow:0 12px 28px rgba(0,212,255,.18)!important;transition:transform .16s ease,filter .16s ease,box-shadow .16s ease}#meetingAdminMount .meeting-small-btn:hover:not(:disabled){filter:brightness(1.04);transform:translateY(-1px);box-shadow:0 14px 32px rgba(0,212,255,.22)!important}#meetingAdminMount .meeting-small-btn.danger{background:linear-gradient(135deg,var(--accent),var(--accent-green))!important;color:#001018!important}.meeting-small-btn:disabled{opacity:.55;cursor:not-allowed}.meeting-table{width:100%;border-collapse:collapse}.meeting-table th,.meeting-table td{padding:11px 10px;border-bottom:1px solid var(--border);text-align:left;vertical-align:top}.meeting-table label{color:var(--text-primary);font-size:13px;white-space:nowrap}.meeting-mobile-list{display:none}.meeting-badge{display:inline-flex;align-items:center;border-radius:999px;padding:3px 8px;margin-right:6px;font-size:12px;font-weight:700}.meeting-badge.owned{background:rgba(0,212,255,.16);color:#7ee5ff}.meeting-badge.all{background:rgba(168,85,247,.18);color:#e9d5ff}
            </style>
            <style>
