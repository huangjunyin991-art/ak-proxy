(function() {
    ...
    function renderSubAdminToggles() {
        ...
        const cards = toggles.map(function(toggle) {
            ...
            return `
                <div class="meeting-mobile-card ${permTone}${disabledClass}">
                    <div class="meeting-mobile-grid">
                        ...
                        <label class="meeting-grid-cell meeting-grid-toggle meeting-grid-full">
                            <span class="meeting-grid-label">允许发布会议</span>
