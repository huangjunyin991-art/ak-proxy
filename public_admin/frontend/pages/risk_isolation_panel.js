(function() {
    ...
    function injectStyle() {
        ...
        style.textContent = [
            ...
            '#riskIsolationPanelMount .ri-toolbar .ri-btn,#riskIsolationPanelMount .ri-row-actions .ri-btn{border:0!important;font-weight:900!important;transition:transform .16s ease,filter .16s ease,box-shadow .16s ease!important}#riskIsolationPanelMount #riIsolateAllBtn{color:#fff7f7!important;background:linear-gradient(135deg,#ff6b6b,#e63946)!important;box-shadow:0 10px 22px rgba(230,57,70,.26)!important}#riskIsolationPanelMount #riReleaseScopeBtn{color:#001018!important;background:linear-gradient(135deg,var(--accent),var(--accent-green))!important;box-shadow:0 10px 22px rgba(0,212,255,.22)!important}#riskIsolationPanelMount .ri-row-actions .ri-btn{min-height:34px!important;border-radius:9px!important;padding:0 11px!important;box-shadow:none!important}#riskIsolationPanelMount .ri-row-actions button[data-ri-action="isolate"]{color:#fff7f7!important;background:linear-gradient(135deg,#ff6b6b,#e63946)!important}#riskIsolationPanelMount .ri-row-actions button[data-ri-action="isolateUmbrella"]{color:#241500!important;background:linear-gradient(135deg,#ffd166,#f8961e)!important}#riskIsolationPanelMount .ri-row-actions button[data-ri-action="release"],#riskIsolationPanelMount .ri-row-actions button[data-ri-action="releaseUmbrella"]{color:#001018!important;background:linear-gradient(135deg,var(--accent),var(--accent-green))!important}#riskIsolationPanelMount .ri-toolbar .ri-btn:not(:disabled):hover,#riskIsolationPanelMount .ri-row-actions .ri-btn:not(:disabled):hover{filter:brightness(1.07);transform:translateY(-1px)}',
