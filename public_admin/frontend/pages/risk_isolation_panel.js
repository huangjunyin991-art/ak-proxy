(function() {
    ...
    function injectStyle() {
        ...
        style.textContent += '.ri-scope-alpha{overflow:hidden;gap:0;padding:3px 2px}.ri-alpha-item{min-height:10px;line-height:10px;border-radius:5px;font-size:9px}';
    ...
    function renderSubAdmins() {
        ...
        menu.innerHTML = '<div class="ri-scope-search"><input id="riSubAdminSearch" value="' + escapeHtml(state.dropdownQuery || '') + '" placeholder="搜索子管理员 / 绑定账号"></div>' +
            '<div class="ri-scope-body"><div class="ri-scope-list">' +
            ...
            '</div><div class="ri-scope-alpha"><button type="button" class="ri-alpha-item' + (!state.selectedInitial ? ' active' : '') + '" data-ri-letter="">全</button>' +
