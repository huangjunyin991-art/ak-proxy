(function() {
    ...
    function injectStyle() {
        ...
        style.textContent = [
            ...
            '.ri-toolbar{display:flex;gap:10px;align-items:center;flex-wrap:wrap}.ri-toolbar>.ri-scope-dropdown{flex:0 0 260px}.ri-toolbar>.ri-input{flex:1 1 280px;max-width:460px}.ri-toolbar>.ri-btn{flex:0 0 auto;width:auto}',
            ...
            '.ri-btn{border:1px solid transparent;border-radius:12px;min-height:42px;padding:0 14px;font-size:14px;font-weight:900;letter-spacing:.01em;white-space:nowrap;cursor:pointer;color:#fff}.ri-btn:disabled{opacity:.55;cursor:not-allowed}.ri-btn.secondary{background:rgba(255,255,255,.06);border-color:rgba(255,255,255,.12)}.ri-btn.danger{background:linear-gradient(135deg,#ff4757,#c44569);box-shadow:0 10px 22px rgba(255,71,87,.18)}.ri-btn.success{background:linear-gradient(135deg,#00b894,#00cec9);box-shadow:0 10px 22px rgba(0,184,148,.18)}',
            '.ri-table-wrap{overflow:auto;-webkit-overflow-scrolling:touch;overscroll-behavior:contain;border:1px solid var(--border);border-radius:14px;background:rgba(255,255,255,.02);position:relative}.ri-table{width:max-content;min-width:980px;border-collapse:separate;border-spacing:0}.ri-table th,.ri-table td{border-bottom:1px solid rgba(255,255,255,.07);padding:8px 10px;text-align:left;white-space:nowrap}.ri-table th{position:sticky;top:0;z-index:20;color:var(--accent);background:var(--bg-secondary);font-size:11px}.ri-table td{font-size:12px;line-height:1.25;color:var(--text-primary);background:var(--bg-card)}.ri-table th:first-child,.ri-table td:first-child{position:sticky;left:0;width:120px;min-width:120px;max-width:120px;z-index:12;background:var(--bg-card)}.ri-table th:first-child{z-index:30;background:var(--bg-secondary)}.ri-table tr:last-child td{border-bottom:0}.ri-table .ri-btn{min-height:34px;border-radius:10px;padding:0 12px;font-size:12px}',
            ...
            '@media(max-width:760px){.ri-card{padding:12px}.ri-toolbar{align-items:flex-start}.ri-toolbar>.ri-scope-dropdown{flex:0 1 260px}.ri-toolbar>.ri-input{flex:1 1 220px;max-width:none}.ri-scope-dropdown{width:260px;min-width:0}.ri-scope-menu{width:min(320px,calc(100vw - 32px));max-width:none}.ri-table{min-width:980px}}',
            '@media(max-width:560px){.ri-toolbar>.ri-scope-dropdown,.ri-toolbar>.ri-input{flex:1 1 100%;width:100%;max-width:none}.ri-scope-dropdown{width:100%;max-width:none}.ri-scope-menu{width:100%;min-width:100%}.ri-toolbar>.ri-btn{flex:0 0 auto}}'
        ].join('');
