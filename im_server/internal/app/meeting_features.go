...
const wemeetJoinBridgeScript = `(function() {
    'use strict';
...
func (a *App) handleMeetingJoinBridgeScript(w http.ResponseWriter, r *http.Request) {
	...
	_, _ = w.Write([]byte(wemeetJoinBridgeScript))
}
